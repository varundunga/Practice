...
public class a {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//a[text()='Folders']")).click();
		 Thread.sleep(10000);
		 driver.findElement(By.xpath("//td[@id='ygtvt8']/a[@class='ygtvspacer' ]")).click();
		 Thread.sleep(10000);
		 driver.findElement(By.xpath("//td[@id='ygtvt36']/a[@class='ygtvspacer' ]")).click();
		 Thread.sleep(10000);
		 driver.findElement(By.xpath("//td[@id='ygtvt41']/a[@class='ygtvspacer' ]")).click();
		 Thread.sleep(10000);
		 driver.findElement(By.xpath("//td[@id='ygtvt46']/a[@class='ygtvspacer' ]")).click();
		 Thread.sleep(10000);
		 driver.findElement(By.id("accordionNavigationView_drawer1_treeView_treeNode51_name")).click();
